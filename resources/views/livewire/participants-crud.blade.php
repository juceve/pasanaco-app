<div class="max-w-9xl mx-auto p-6">
    ...
    <div class="max-w-9xl mx-auto p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:text-gray-200">

        {{-- Títulos y botón Nuevo alineados --}}
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
            <div>                   
                <h5 class="title-h5 mb-0 text-sky-700 dark:text-gray-400">Listado completo de participantes registrados
                </h5>
            </div>
        ...
        <div class="overflow-x-auto rounded-lg shadow ring-1 ring-black ring-opacity-5 dark:ring-gray-700">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span
                                        ...
                                        <svg class="w-3 h-3 mr-1 text-red-500 dark:text-red-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <circle cx="10" cy="10" r="10" />
                                        </svg>
                                        Inactivo
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-10 text-gray-400 dark:text-gray-500 italic">No hay
                                participantes registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
