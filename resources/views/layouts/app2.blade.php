            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1088px, 3335px);">
                        <div
                    ...
                    <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1128px, 3335px);">
                        <div
                            class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Apps
                        </div>
                    ...
                    <div id="tooltip-toggle" role="tooltip"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1096px, 63px);">
                        Toggle dark mode
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1216px, 3331px);">
            ...
            <div
                ...
                <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
                    ...
                    <div id="tooltip-settings" role="tooltip"
                        ...
                        Settings page
                        <div class="tooltip-arrow" data-popper-arrow=""
                            style="position: absolute; left: 0px; transform: translate(54px, 0px);"></div>
                    </div>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 4217px);">
                        <ul class="py-1" role="none">
                            <li>
                                <a href="#"
                                ...
                                <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <li class="pt-4 pb-6">
                                        <div class="flex items-center space-x-4">
                                            <div class="flex-shrink-0">
                                                <svg class="w-5 h-5 dark:text-white" aria-hidden="true"
                                                    focusable="false" data-prefix="fab" data-icon="dribbble"
                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 512 512">
                                                    <path fill="currentColor"
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input data-popover-target="popover-password"
                                            data-popover-placement="bottom" type="password" id="password"
                                        ...
                                        <div data-popover="" id="popover-password" role="tooltip"
                                            ...
                                            data-popper-escaped=""
                                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(589px, 2461px);">
